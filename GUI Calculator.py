...
txtDisplay = Entry(cal,font=('arial', 20, "bold"), textvariable= text_Input, bd=30, 
                    insertwidth= 4, bg= "pink", justify="right" ).grid(columnspan=5)




btn9 = Button(cal,padx=16, bd=8, fg="black", font=("arial", 20, "bold"),
                 text="9", command= lambda: btnClick(9)).grid(row=1, column=0)
...
btn7 = Button(cal,padx=16, bd=8, fg="black", font=("arial", 20, "bold"),
                 text="7", command= lambda: btnClick(7)).grid(row=1, column=2)
...
btnmMul = Button(cal,padx=16, bd=8, fg="black", font=("arial", 20, "bold"), 
...
btnEql = Button(cal,padx=16, bd=8, fg="black", font=("arial", 20, "bold"),  
